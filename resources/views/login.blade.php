    ...
    <div class ="wrapper fadeInDown">
      <div id="formContent">
        ...
        <div class="fadeIn first">
            <img src="./img/core-img/KFA.jpg" id="icon" alt="User Icon" />
          </div>
      ...
      <div class="form" style="text-align:center"> --}}
         <form action="#">
          <table>
            <tr><td><input type="text" class="fadeIn second" name="username" id="username" placeholder="Enter username" required></td></tr>            
            <tr><td><input type="password" class="fadeIn third" name="password" id="password" placeholder="Enter Password" required></td></tr>
              <tr><td><input class="fadeIn fourth" type="submit" value="Login"></td><tr>
                <tr><td id="formFooter"><a class="underlineHover" href="#">Sign up</td></tr>
          </table>
        </form>
      </div>
    </div>
