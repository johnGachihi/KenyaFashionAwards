    ...
    <div class="main-header-area">
      <div class="classy-nav-container breakpoint-off">
        ...
        <nav class="classy-navbar justify-content-between" id="monaNav">
         ...
         <!-- Logo -->
          <a class="nav-brand" href="index.php"><img src="./img/core-img/KFA.png" alt=""></a>
          ...
          <div class="classy-menu">
            ...
            <div class="classynav">
              <ul id="nav">
                ...
                <li><a href="#">Awards</a>
                  <ul class="dropdown">
                    <li><a href="./index">-Category for the awards</a></li>
                    <li><a href="./about">-Criteria of awards</a></li>
                    <li><a href="./projects">-Judges</a></li>
                    </ul>
                </li>
                <li><a href="./projects.php">Register</a></li>
                <li><a href="./models.php">Vote</a></li>
          ...
          <div class="row h-100 align-items-center">
            <div class="col-12">
              <div class="welcome-text">
                <h2 data-animation="bounceInUp" data-delay="400ms">Edwards <br>
                  Mwangi</h2>
      ...
      <div class="single-welcome-slide">
        ...
        <div class="container h-100">
          <div class="row h-100 align-items-center">
            <div class="col-12">
              <div class="welcome-text">
                <h2 data-animation="bounceInUp" data-delay="400ms">Wambui
                  </h2>
                <h5 data-animation="bounceInUp" data-delay="600ms">Star Model 2019</h5>
                <a href="#" class="btn" data-animation="bounceInUp" data-delay="800ms">Model details <i class="arrow_right"></i></a>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-lg-4">
          <div class="about-us-content mb-50 wow fadeInUp" data-wow-delay="700ms">
            <h2> Kenya Fashion Awards</h2>
            <p>The Kenya Fashion Awards is an Awards winning awarding prestigious trade mark event that incorporates fashion, music, photography and art to create a magical runway experience and recognize and award the most talented in the industry.</p>
            <p>Activities at the Kenya Fashion Awards include: modeling Academy, talent search and training, workshops; press conferences, private cocktail parties for sponsors, designers, fashion people, celebrities and entrepreneurs.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="100ms">
              <i class="icon_film"></i>
              <h5>Fashion Shows</h5>
              <p>The catwalk schedule is suitable for designers wishing to show their collections on the runway</p>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="300ms">
              ...
              <p>After party events with the sponsors of the Kenya Fashion AWards</p>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="500ms">
              ...
              <h5>Photographers</h5>
              <p> specialize in the genre of fashion, commercial or related photography</p>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="700ms">
              ...
              <h5>Model school</h5>
              <p>A place where models practise for their runway</p>
            </div>
          </div>
        ...
        <div class="col-12">
          <div class="model-tab-area">
            ...
            <ul class="nav nav-tabs mb-50" id="mona_modelTab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="tab3" data-toggle="tab" href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="false">Designers</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="tab4" data-toggle="tab" href="#tab-4" role="tab" aria-controls="tab-4" aria-selected="false">Photographers</a>
              </li>
            </ul>
          </div>
        </div>
