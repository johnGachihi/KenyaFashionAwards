          ...
          <div class="classy-menu">
            ...
            <div class="classynav">
              <ul id="nav">
                ...
                <li><a href="#">Awards</a>
                  <ul class="dropdown">
                    <li><a href="./index">-Awards category</a></li>
                    <li><a href="./about">-awards criteria</a></li>
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-12 col-lg-4">
          <div class="about-us-thumbnail mb-50">
            ...
            <img src="./img/bg-img/kenya1.jpg" alt="">
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
          <div class="single-footer-widget mb-60">
            <!-- Logo -->
            <a href="#" class="d-block mb-4"><img src="./img/core-img/KFA.png" alt=""></a>
